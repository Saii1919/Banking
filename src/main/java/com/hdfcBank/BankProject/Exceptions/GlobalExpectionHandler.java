package com.hdfcBank.BankProject.Exceptions;


import com.hdfcBank.BankProject.DTO.ErrorResponseDTO;
...
public class GlobalExpectionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        validationErrorList.forEach((error)->{
            String feidNme =((FieldError) error).getField();
            String ValidationMsg=error.getDefaultMessage();
            validationErrors.put(feidNme,ValidationMsg);
        });
